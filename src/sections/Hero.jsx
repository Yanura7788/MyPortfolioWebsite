          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight animate-fade-in animation-delay-100">
                Code <span className="text-primary glow-text"> <br />
                Create
                <br /></span>
           ...
           <div className="flex flex-wrap gap-4 animate-fade-in animation-delay-300"> <Button size="lg"> Contact Me <ArrowRight className="w-5 h-5" /> </Button> <AnimatedBorderButton> <Download className="w-5 h-5" /> Download CV </AnimatedBorderButton> </div> 

            {/* Social Links */}
            <div className="flex items-center gap-4 animate-fade-in animation-delay-400">
              <span className="text-sm text-muted-foreground">Follow me: </span>
              {[
                { icon: Github, href: "https://github.com/Yanura7788" },
                { icon: Linkedin, href: "https://www.linkedin.com/in/xavierno-yanura-alexander-8859a4192/" },
                { icon: Instagram, href: "https://www.instagram.com/xaviernoyanura/" },
              ].map((social, idx) => (
                <a
                  key={idx}
                  href={social.href}
